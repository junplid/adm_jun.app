...
function QRCode(props: { changeType: () => void }): JSX.Element {
  return (
    <div className="grid grid-cols-[1fr_300px] gap-x-1">
...
function PIN(props: { changeType: () => void }): JSX.Element {
  const {
    handleSubmit,
    register,
    control,
      ...
      <div>
        ...
        <p className="text-white/75">
          ...
          <strong className="font-semibold text-white">
            {getValues("number")} +55 71 98675-1101
          </strong>
        </p>
      </div>
  ...
  return (
    <div className="flex flex-col gap-y-10 justify-center items-center">
      <div className="flex flex-col gap-y-5 justify-center items-center">
        ...
        <Button rounded={"full"} px="30px" size={"sm"} colorPalette={"teal"}>
          Avançar
        </Button>
      </div>
      <button
    ...
    <DialogContent backdrop>
      ...
      <DialogBody>
        {typeConnection === "QRCODE" && (
          <QRCode changeType={() => setTypeConnection("PIN")} />
        )}
        {typeConnection === "PIN" && (
          <PIN changeType={() => setTypeConnection("QRCODE")} />
        )}
      </DialogBody>
