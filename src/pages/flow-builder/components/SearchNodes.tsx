...
import { FaRandom, FaRoute } from "react-icons/fa";
...
const nodesList: {
  ...
  {
    icon: <FaRoute className="text-green-400 w-8" size={31} />,
    name: "Append rota",
  ...
  {
    icon: <FaRoute className="text-gray-400 w-8" size={31} />,
    name: "Buscar rota",
  ...
  {
    icon: <FaRoute className="text-red-400 w-8" size={31} />,
    name: "Remover pedido da rota",
    description: "Remove ordem da rota",
    type: "NodeDeleteRouterOrder",
    new: false,
    premium: true,
  },
  {
  ...
  {
    icon: <FaRoute className="text-blue-400 w-8" size={31} />,
    name: "Atualizar rota",
    description: "Atualiza rota",
    type: "NodeUpdateRouter",
    new: false,
    premium: true,
  },
  {
