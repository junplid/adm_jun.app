...
export const DigitizingChatComponent = memo(
  ({
    active,
    list,
    onVisibilityChange,
    ...
    return (
      <div
        ...
        className="flex pointer-events-none! relative flex-col justify-end h-28 overflow-hidden z-10"
        ref={ref}
      >
        {ismodal && (
        ...
        <div
          ref={parent}
          className="flex-1 z-0 px-3 sm:px-6 flex gap-y-1 flex-col p-3 h-full justify-end overflow-hidden"
        >
